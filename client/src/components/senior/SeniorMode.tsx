...
const NOMINEES = [
  { id: 'nom-1', name: 'Rahul Sharma (Son)', relation: 'Son', percentage: 60, contact: '+91 98765 43210' },
      ...
      {showEmergencyCalled && (
        <div className="p-4 bg-emerald-50 border-2 border-emerald-300 rounded-2xl text-center animate-fade-in">
          <p className="text-lg font-bold text-emerald-700">
            <i className="fas fa-phone mr-2" /> Calling Rahul Sharma...
          </p>
            ...
            {showFamilyConnect && (
              <div className="p-6 bg-emerald-50 border-2 border-emerald-300 rounded-2xl text-center animate-fade-in">
                ...
                <p className="text-base text-emerald-600 mt-1">
                  Rahul and Priya have received a read-only summary of your accounts.
                </p>
                <button
