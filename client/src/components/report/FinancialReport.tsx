    ...
    <div className="fixed inset-0 z-[100] bg-white overflow-y-auto">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-slate-800">Financial Report</p>
            <p className="text-[10px] text-slate-400">{new Date().toLocaleDateString('en-IN', { month: 'long', year: 'numeric' })} • {format.toUpperCase()} Format</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button onClick={onClose} className="px-4 py-2 bg-slate-100 text-slate-700 text-sm font-medium rounded-xl hover:bg-slate-200 transition-colors">
