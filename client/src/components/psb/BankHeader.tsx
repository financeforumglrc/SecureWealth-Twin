            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <p className="text-[13px] font-semibold leading-tight">Rahul Sharma</p>
                  ...
                  <>
                    ...
                    >
                      <div className="px-4 py-3 border-b border-gray-100">
                        ...
                        <p className="text-xs text-gray-500">rahul.sharma@email.com</p>
                      ...
                      <div className="py-1">
                        ...
                        <button onClick={() => { useWealthStore.getState().toggleFamilyMode(); setProfileOpen(false); }} className="w-full text-left px-4 py-2.5 text-sm hover:bg-gray-50 flex items-center gap-3">
                          <i className="fas fa-people-group text-primary w-4" /> Family View
                        </button>
                      </div>
