        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          {showDisclaimer && (
            <div className="mt-4 p-4 bg-gray-50 rounded-sm text-[10px] text-gray-500 leading-relaxed">
              Punjab & Sind Bank is a government-owned bank established in 1908. This application is for demonstration and hackathon purposes only. 
              All financial data shown is simulated. For actual banking services, please visit your nearest PSB branch or use our official Internet Banking portal. 
