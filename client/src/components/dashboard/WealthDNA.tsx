      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-slate-500">Your financial fingerprint</p>
          </div>
          ...
          <div className="relative" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full overflow-hidden relative">
              ...
              <div className="relative text-center">
                ...
                <h3 className="text-xl font-bold text-slate-800">My Wealth DNA</h3>
                      ...
                      return (
                        <div key={key} className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-slate-700">{axis.label}</span>
                          </div>
