...
export default function VoicePayment({ onPay }: Props) {
  ...
  const startListening = useCallback(() => {
    ...
    if (!SpeechRecognition) {
      ...
      setIsListening(true);
      setTimeout(() => {
        setTranscript('Pay five hundred rupees to Rahul');
        setParsed({ amount: 500, payee: 'Rahul' });
  ...
  return (
    <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-5 text-white relative overflow-hidden">
      ...
      <div className="relative">
        ...
        <p className="text-xs text-white/70 mb-4">Say: "Pay 500 to Rahul"</p>
