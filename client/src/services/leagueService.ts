...
const LEAGUES: FantasyLeague[] = [
  ...
  { id: 'l2', name: 'SIP Champions', icon: 'fa-medal', members: 856, myRank: 12, topPerformer: 'Rahul S.', weeklyTheme: 'Goal Completion Speed' },
...
const LEADERBOARD: FantasyPlayer[] = [
  ...
  { id: 'p2', name: 'Rahul S.', avatar: 'RS', portfolioValue: 1980000, savingsRate: 35, goalProgress: 65, weeklyReturn: 2.8, strategy: 'Balanced mix of equity and debt with gold hedge' },
