...
export type ViewType = 
  ...
  | 'tax' | 'privacy' | 'calculators' | 'transactions' | 'architecture' | 'bills' | 'credit-health' | 'notification-demo' | 'digital-gold' | 'challenges' | 'kids-mode' | 'subscriptions' | 'accessibility' | 'nri-mode' | 'business-mode' | 'values-alignment' | 'fantasy-league' | 'boosts' | 'security-beast' | 'innovation-lab' | 'payments';
